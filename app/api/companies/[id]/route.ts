    ...
    const updated = await prisma.$transaction(async (tx) => {
      ...
      return tx.company.update({
        ...
        data: {
          ...
          atAGlanceProblem: input.atAGlanceProblem || null,
          atAGlanceSolution: input.atAGlanceSolution || null,
          atAGlanceImpact: input.atAGlanceImpact || null,
          atAGlanceKeyStrengths: input.atAGlanceKeyStrengths || null,
          atAGlanceKeyConsiderations: input.atAGlanceKeyConsiderations || null,
