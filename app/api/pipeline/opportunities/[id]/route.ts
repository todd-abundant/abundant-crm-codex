  ...
  try {
    ...
    return NextResponse.json({
      item: {
        ...
        leadSourceType: company.pipeline?.leadSourceType ?? null,
        leadSourceEntityType: company.pipeline?.leadSourceEntityType ?? null,
        leadSourceEntityId: company.pipeline?.leadSourceEntityId ?? null,
        leadSourceEntityName: company.pipeline?.leadSourceEntityName ?? null,
        pipelineCompanyType: company.pipeline?.pipelineCompanyType ?? null,
        fundingStage: company.pipeline?.fundingStage ?? null,
        amountRaising: company.pipeline?.amountRaising ? company.pipeline.amountRaising.toNumber() : null,
        targetCustomer: company.pipeline?.targetCustomer ?? null,
        valueProp: company.pipeline?.valueProp ?? null,
        submittingHealthSystemId: company.pipeline?.submittingHealthSystemId ?? null,
        intakeStep: company.pipeline?.intakeStep ?? null,
